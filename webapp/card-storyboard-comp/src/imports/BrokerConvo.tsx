import svgPaths from "./svg-5f4joo19rp";
...
function Paragraph() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Paragraph">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#fefae0] text-[12px] w-[240px] whitespace-pre-wrap">I’m meeting a potential buyer for Treppan Living Privé. They’ve been renting in Dubai for six years and are tired of annual rent hikes.</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Paragraph">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[21px] min-h-px min-w-px not-italic relative text-[#fefae0] text-[12px] whitespace-pre-wrap">Understood. Based on that profile, they align with. Does this client have a family, and are they looking for a home near international schools?</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[16px] p-[16px] rounded-[16px] top-[469px] w-[361px]" data-name="Container" style={{ backgroundImage: "linear-gradient(104.656deg, rgba(121, 168, 226, 0.22) 1.7819%, rgba(153, 153, 153, 0.22) 100.06%)" }}>
      <div aria-hidden="true" className="absolute border-[0.587px] border-[rgba(255,255,255,0.1)] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <Paragraph1 />
    </div>
  );
...
export default function BrokerConvo() {
  return (
    <div className="bg-black content-stretch flex flex-col items-center justify-end relative size-full" data-name="Broker Convo">
      <Background />
